    ...
    <section data-section="app-preview" className="section-padding bg-fablino-light-gray">
      <div className="container-fablino text-center">
        ...
        <div className="fade-in-section inline-block">
          <div className="max-w-[700px] mx-auto bg-card rounded-[1.75rem] border border-foreground/20 shadow-[0_24px_64px_-8px_rgba(0,0,0,0.22),0_0_0_1px_rgba(0,0,0,0.06)] overflow-hidden flex flex-col">
