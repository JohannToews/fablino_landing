...
export const translations: Record<string, Record<Language, string>> = {
  ...
  feature_1_title: {
    de: "Kinder wollen mehr lesen",
    en: "Kids want to read more",
    fr: "Les enfants veulent lire davantage",
    es: "Los niños quieren leer más",
  },
  feature_1_desc: {
    de: "Geschichten so fesselnd, dass dein Kind um ein weiteres Kapitel bittet.",
    en: "Stories so engaging your child asks for one more chapter.",
    fr: "Des histoires si captivantes que votre enfant en redemande un chapitre de plus.",
    es: "Historias tan fascinantes que tu hijo pide un capítulo más.",
  },
  feature_2_title: {
    de: "Echtes Leseverständnis",
    en: "Real reading comprehension",
    fr: "Vraie compréhension de lecture",
    es: "Comprensión lectora real",
  },
  feature_2_desc: {
    de: "Quizzes nach jeder Geschichte fördern Verstehen — nicht nur lesen, sondern wirklich begreifen.",
    en: "Quizzes after every story build understanding — not just reading, but truly getting it.",
    fr: "Des quiz après chaque histoire développent la compréhension — pas seulement lire, mais vraiment comprendre.",
    es: "Cuestionarios tras cada historia desarrollan la comprensión — no solo leer, sino entender de verdad.",
  },
  feature_3_title: {
    de: "Geschichten, die wirklich prägen",
    en: "Stories that teach what matters",
    fr: "Des histoires qui enseignent l'essentiel",
    es: "Historias que enseñan lo que importa",
  },
  feature_3_desc: {
    de: "Du wählst die Themen: Mut, Empathie, Teamwork. Jedes Abenteuer trägt deine Werte.",
    en: "You choose the themes: courage, empathy, teamwork. Every adventure carries your values.",
    fr: "Vous choisissez les thèmes : courage, empathie, travail d'équipe. Chaque aventure porte vos valeurs.",
  ...
  faq_subline: {
    de: "Alles was du über Fablino wissen musst",
    en: "Everything you need to know about Fablino",
  ...
  faq_1_q: {
    de: "Was ist Fablino?",
    en: "What is Fablino?",
    fr: "Qu'est-ce que Fablino ?",
    es: "¿Qué es Fablino?",
  },
  faq_1_a: {
    de: "Fablino ist eine KI-gestützte Lese-App für Kinder zwischen 6 und 10 Jahren. Die App erstellt personalisierte Geschichten mit Bildern, Verständnisfragen und einem Belohnungssystem – alles abgestimmt auf das Alter, die Interessen und die Sprache deines Kindes.",
    en: "Fablino is an AI-powered reading app for children aged 6 to 10. The app creates personalized stories with images, comprehension questions and a reward system – all tailored to your child's age, interests and language.",
  ...
  story_placeholder: {
    de: "Unsere Geschichte kommt bald… 🦊",
    en: "Our story is coming soon… 🦊",
    fr: "Notre histoire arrive bientôt… 🦊",
    es: "Nuestra historia llegará pronto… 🦊",
  },
};
